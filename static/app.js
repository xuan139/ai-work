const messages = {
  "zh-Hant": {
    ...
    nasFeatures: {
      eyebrow: "NAS Demo",
      title: "模擬企業 NAS 會議資料入口",
      copy: "把共享資料夾當作語音資產進站點：檔案一進 inbox 就被發現、通知、搬移、入庫、轉寫，後續可依權限查詢。",
      dropzoneTitle: "共享目錄 Drop Zone",
      dropzoneCopy: "使用 mock_nas/inbox 模擬 SMB / NFS 共享資料夾，會議錄音可由錄音筆、會議室主機或同步工具放入。",
      watchTitle: "熱資料夾監聽",
    ...
    record: {
      ...
      resume: "繼續",
      stop: "停止並保存",
      hint: "瀏覽器會請求麥克風權限。停止後系統會把原始錄音保存到本地 storage，模擬 NAS 會議音訊歸檔，再進入轉寫佇列。",
      defaultTitle: "瀏覽器錄音",
  ...
  en: {
    ...
    nasFeatures: {
      eyebrow: "NAS Demo",
      title: "Enterprise NAS meeting intake simulation",
      ...
      dropzoneCopy: "mock_nas/inbox simulates an SMB / NFS share where recorders, room PCs, or sync tools can place meeting audio.",
